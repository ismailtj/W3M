...
class AccountInvoiceLine(models.Model):
    ...
    def asset_create(self):
        ...
        asset = self.env['account.asset.asset'].search([('invoice_id', '=', self.invoice_id.id)])
        print('ggggg', self.invoice_id.date_invoice)

        if asset:
            print('ggggg', self.invoice_id.date_invoice)
            asset.write({'invoice_date': self.invoice_id.date_invoice})
