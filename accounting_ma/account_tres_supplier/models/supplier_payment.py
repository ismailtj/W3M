...
class SupplierPayment(models.Model):
    ...
    invoice_ids = fields.Many2many('account.invoice', 'paiement_supplier_invoice_rel', 'paiement_record_id','invoice_id', u'Factures',readonly=True,states={'draft':[('readonly', False)]})
