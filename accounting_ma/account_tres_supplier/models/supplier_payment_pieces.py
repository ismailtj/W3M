...
class PaiementCashSupplier(models.Model):
    ...
    journal_id = fields.Many2one('account.journal', string=u'Journal', required=True, states={'done':[('readonly', True)]})
    period_id = fields.Many2one('date.range', string=u'Période', required=True)
    note = fields.Text(string=u"Notes")
    partner_id = fields.Many2one('res.partner', string=u'Fournisseur', required=True, states={'done': [('readonly', True)]})
    move_line_ids = fields.One2many('account.move.line', 'cash_supplier_id', string=u'Lignes comptables', states={'done': [('readonly', True)]})
    ...
    company_id = fields.Many2one('res.company', string=u'Societé', required=True, states={'done':[('readonly', True)]},
                                 default=lambda self: self.env['res.company']._company_default_get('paiement.cash.supplier'))
    analytic_account_id = fields.Many2one('account.analytic.account', string=u'Compte Analytique', states={'done': [('readonly', True)]})
...
class PaiementChequeSupplier(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string=u'Fournisseur', required=True, states={'done': [('readonly', True)]})
    move_line_ids = fields.One2many('account.move.line', 'cheque_supplier_id', string=u'Lignes Comptables', states={'done': [('readonly', True)]})
    ...
    company_id = fields.Many2one('res.company', string=u'Societé', required=True,
                                 default=lambda self: self.env['res.company']._company_default_get('paiement.cheque.supplier'))
...
class PaiementEffetSupplier(models.Model):
    ...
    model_id = fields.Many2one('paiement.effet.model.supplier', string=u'Model comptable', required=True, states={'payed': [('readonly', True)]})
    ...
    move_line_ids = fields.One2many('account.move.line', 'effet_supplier_id','Lignes comptables', states={'payed': [('readonly', True)]})
    period_id = fields.Many2one('date.range', string=u'Période', required=True)
    caisse_id = fields.Many2one('paiement.caisse', string=u'Caisse')
    company_id = fields.Many2one('res.company', string=u'Societé', required=True,
                                 default=lambda self: self.env['res.company']._company_default_get(
                                     'paiement.effet.supplier'))
    analytic_account_id = fields.Many2one('account.analytic.account', string=u'Compte analytique', states={'payed': [('readonly', True)]})
...
class PaiementOvSupplier(models.Model):
    ...
    note = fields.Text(string=u"Notes")
    partner_id = fields.Many2one('res.partner', string=u'Fournisseur', required=True, states={'done': [('readonly', True)]})
    move_line_ids = fields.One2many('account.move.line', 'ov_supplier_id',string=u'Lignes Comptables', states={'done':[('readonly', True)]})
    period_id = fields.Many2one('date.range', string=u'Période', required=True)
    caisse_id = fields.Many2one('paiement.caisse', string=u'Caisse')
    company_id = fields.Many2one('res.company', string=u'Societe', required=True,
                                 default=lambda self: self.env['res.company']._company_default_get('paiement.ov.supplier'))
    analytic_account_id = fields.Many2one('account.analytic.account', string=u'Compte Analytique', states={'done':[('readonly', True)]})
