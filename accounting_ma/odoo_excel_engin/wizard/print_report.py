...
class PrintReport(models.TransientModel):
    ...
    def print_report(self):
        ...
        return self.with_context(ex_n=ex_n,ex_n_1=ex_n_1).env['ir.actions.report']._get_report_from_name('report.engin.xlsx').with_context(ex_n=ex_n,ex_n_1=ex_n_1).report_action(self.env['report.engin'].browse(report_list),{'ex_n':ex_n,'ex_n_1':ex_n_1})
